...
vtkStandardNewMacro(vtkPolytopeGeometry);

//----------------------------------------------------------------------------
// Polytope storage 
//----------------------------------------------------------------------------

vtkPolytopeGeometry::vtkPolytopeGeometry()
{
...
// dimensionality.
void vtkPolytopeGeometry::Initialize(
  const short m, 
  const short n,
...
void vtkPolytopeGeometry::ResetForNextCell(const double *domainBounds)
{
  ...
  for (int i = 1; i < vtkPolytopeGeometry::TABSIZE; i++)
    {
    this->SetSize[i] = -1;
    }
...
vtkIdType vtkPolytopeGeometry::AddPtope(vtkIdType *pt, int d, int sz)
{
  vtkIdType p;
  ...
  h = h % vtkPolytopeGeometry::TABSIZE;
  ...
  while (true)
    ...
    if (this->SetSize[h] < 0)
      ...
      h++;
      if (h == vtkPolytopeGeometry::TABSIZE) h = 0;
      }
    }
...
vtkIdType vtkPolytopeGeometry::BuildFromSimplex(vtkIdType *pt, int d)
{
...
vtkIdType vtkPolytopeGeometry::AddCoord(const double *dc, const double *rc)
{ 
  vtkIdType pid;
  int unseen;
  double *base;
...
void vtkPolytopeGeometry::GetActiveDomCoord(vtkIdType id, double *c)
{
...
void vtkPolytopeGeometry::GetActiveRngCoord(vtkIdType id, double *c)
{
  id = -1 - id;
...
double vtkPolytopeGeometry::GetActiveDomCoordComponent(vtkIdType id,  int c)
{
...
double vtkPolytopeGeometry::GetActiveRngCoordComponent(vtkIdType id,  int c)
{
...
double vtkPolytopeGeometry::GetStoredRangeComponent(vtkIdType id, int c)
{
...
// an active polytope.
double *vtkPolytopeGeometry::GetPtopeCoordMin(vtkIdType id)
{
...
void vtkPolytopeGeometry::GetPtopeFacets(vtkIdType pid, vtkIdType *&ids, int &nr)
{
...
double *vtkPolytopeGeometry::GetPtopeCenter(vtkIdType pid)
{
...
void vtkPolytopeGeometry::Split(
...
void vtkPolytopeGeometry::SplitPtope(
...
void vtkPolytopeGeometry::SplitEdge(
...
vtkIdType vtkPolytopeGeometry::Select(
  vtkIdType *pts,
...
void vtkPolytopeGeometry::StoreActivePolytopes(vtkIdType *ids, int nrPtopes)
{
  vtkIdType pid;
  bool unseen;
...
void vtkPolytopeGeometry::PrintSelf(ostream &os, vtkIndent indent)
{
...
void vtkPolytopeGeometry::PrintToplevel(ostream &os, vtkIdType *top, int sz)
{
  struct _Ptope *entry = this->Ptope;
  vtkIdType pt, f;
