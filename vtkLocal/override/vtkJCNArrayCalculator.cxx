 ...
 *	File: vtkJCNArrayCalculator.cxx
...
vtkStandardNewMacro(vtkJCNArrayCalculator);

vtkJCNArrayCalculator::vtkJCNArrayCalculator()
{
...
void vtkJCNArrayCalculator::SetResultArrayName(const char* name)
{
  if (name == NULL || *name == '\0')
    {
...
int vtkJCNArrayCalculator::RequestData(
...
void vtkJCNArrayCalculator::SetFunction(const char* function)
{
...
void vtkJCNArrayCalculator::AddScalarArrayName(const char* arrayName,
                                            int component)
{
  if (!arrayName)
    {
...
void vtkJCNArrayCalculator::AddVectorArrayName(const char* arrayName,
...
void vtkJCNArrayCalculator::AddScalarVariable(const char* variableName,
...
void vtkJCNArrayCalculator::AddVectorVariable(const char* variableName,
                                           const char* arrayName,
                                           int component0, int component1,
                                           int component2)
{
...
void vtkJCNArrayCalculator::AddCoordinateScalarVariable(const char* variableName,
                                                     int component)
{
  int i;
...
void vtkJCNArrayCalculator::AddCoordinateVectorVariable(const char* variableName,
                                                     int component0, 
                                                     int component1, 
                                                     int component2)
{
...
const char* vtkJCNArrayCalculator::GetAttributeModeAsString()
{
  if ( this->AttributeMode == VTK_ATTRIBUTE_MODE_DEFAULT )
    {
    return "Default";
...
void vtkJCNArrayCalculator::RemoveScalarVariables()
{
  int i;
...
void vtkJCNArrayCalculator::RemoveVectorVariables()
{
  int i;
...
void vtkJCNArrayCalculator::RemoveCoordinateScalarVariables()
{
  int i;
...
void vtkJCNArrayCalculator::RemoveCoordinateVectorVariables()
{
  int i;
...
void vtkJCNArrayCalculator::RemoveAllVariables()
{
...
char* vtkJCNArrayCalculator::GetScalarArrayName(int i)
{
...
char* vtkJCNArrayCalculator::GetVectorArrayName(int i)
{
...
char* vtkJCNArrayCalculator::GetScalarVariableName(int i)
{
  if (i < this->NumberOfScalarArrays)
    {
...
char* vtkJCNArrayCalculator::GetVectorVariableName(int i)
{
  if (i < this->NumberOfVectorArrays)
    {
...
int vtkJCNArrayCalculator::GetSelectedScalarComponent(int i)
{
  if (i < this->NumberOfScalarArrays)
    {
...
int* vtkJCNArrayCalculator::GetSelectedVectorComponents(int i)
{
  if (i < this->NumberOfVectorArrays)
    {
...
void vtkJCNArrayCalculator::PrintSelf(ostream& os, vtkIndent indent)
{
