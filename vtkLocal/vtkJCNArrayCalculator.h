...
// .NAME vtkJCNArrayCalculator - perform mathematical operations on data in field data arrays
// .SECTION Description
// vtkJCNArrayCalculator performs operations on vectors or scalars in field
...
#ifndef __vtkJCNArrayCalculator_h
#define __vtkJCNArrayCalculator_h
...
class VTKFILTERSCORE_EXPORT vtkJCNArrayCalculator : public vtkDataSetAlgorithm 
{
public:
  vtkTypeMacro(vtkJCNArrayCalculator,vtkDataSetAlgorithm);
  void PrintSelf(ostream& os, vtkIndent indent);

  static vtkJCNArrayCalculator *New();
...
protected:
  ...
  int     ResultArrayType;
private:
  vtkJCNArrayCalculator(const vtkJCNArrayCalculator&);  // Not implemented.
  void operator=(const vtkJCNArrayCalculator&);  // Not implemented.
};
